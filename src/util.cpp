...
int nAnonymizeCitronAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Citron
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Citron
    // Mac: ~/Library/Application Support/Citron
    // Unix: ~/.Citron
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Citron";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Citron.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "citrond.pid"));
