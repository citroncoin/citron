...
static const int64_t DARKSEND_COLLATERAL = (4*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 0.4 * COIN; //Constant reward of 3.5 CTRN per COIN
...
static const int64_t MIN_TX_FEE = 90000;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 45000000 * COIN; // 1M PoW coins
...
inline int64_t GetMNCollateral(int nHeight) { return 4500; }
